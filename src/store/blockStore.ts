...
export const useBlocksStore = create<BlocksStore>()(
  persist(
    (set, get) => ({
      blocks: [{
  id: '1',
  text: "Drinking water isn't just about quenchingdfdfdfdfdf",
  indicator:1,
  indicatorStatus:false,
  variant: 'text',
},{
  id: '1-1',
  text: "Drinking water isn't just about quenchingdfdfdfdfdffd",
  indicator:1,
  indicatorStatus:false,
  variant: 'text',
},{
  id: '2',
  text: "Drinking water isn't just about quenching your thirst. It plays a crucial role in about quenching bbbbbbbbbbb",
  indicator:100,
  indicatorStatus:false,
  variant: 'text',
},{
